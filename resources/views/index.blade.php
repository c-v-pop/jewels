        ...
        <article class="mt-16">
            ...
            <div class="flex lg:flex-row-reverse flex-col items-center gap-12 mx-4 mb-14">
                <p class="text-3xl leading-loose">
                    ...
                    <img src="{{ asset('/images/green_pearl_necklace.jpg') }}" alt="Crystals Necklace" class="lg:w-1/3 lg:h-[40rem] rounded-3xl">
            </div>
            <div class="flex items-center gap-12 mx-4 lg:flex-row flex-col">
                <p class="text-3xl leading-loose">
                    ...
                    <img src="{{ asset('/images/teal_pearl_necklace.jpg') }}" alt="Crystals Necklace" class="lg:w-1/3 lg:h-[40rem] rounded-3xl">
            </div>
