    ...
    <article class="mt-16">
        <div class="flex flex-col mx-auto w-fit">
            <div class="flex lg:flex-row-reverse flex-col items-center gap-12 mx-4 mb-14">
                ...
                <img src="{{ asset('/images/green_pearl_necklace.jpg') }}" alt="Crystals Necklace" class="lg:w-1/3 lg:h-[25rem] rounded-3xl">
            </div>
            ...
            <div class="flex lg:flex-row-reverse flex-col items-center gap-12 mx-4 mt-10 lg:text-center">
                ...
                <img src="{{ asset('/images/unique_hoop_pearl_necklace.jpg') }}" alt="Crystals Necklace" class="lg:w-1/3 lg:h-[25rem] rounded-3xl">
            </div>
